...
class TestOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--modules', default=["celeb_female","hair_sum","color_sum"], type=list(str), help="Which modules will be combined?")
		self.parser.add_argument('--texts', default=["Elsa","wavy","pink"], type=list(str), help="The latents for the test")
